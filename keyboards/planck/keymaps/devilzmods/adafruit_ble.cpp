...
#include "tmk_core/protocol/lufa/ringbuffer.hpp"
#include <string.h>
...
#define SCK_DIVISOR (72000000UL / AdafruitBleSpiClockSpeed) //normally uses F_CPU
...
bool adafruit_ble_enable_keyboard(void) {
    ...
    static const char kGapDevName[] PROGMEM = "AT+GAPDEVNAME=PlanckBLE"; //STR(PRODUCT);
